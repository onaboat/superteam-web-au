...
function Avatar({
  ...
  size?: "default" | "sm" | "lg"
  /** Sharp corners + chart border — matches brutalist member / post cards */
  square?: boolean
}) {
  return (
    <AvatarPrimitive.Root
      ...
      className={cn(
        ...
        square
          ? "rounded-none after:rounded-none after:border-chart-1"
...
function AvatarImage({
  ...
  return (
    <AvatarPrimitive.Image
      ...
      className={cn(
        "aspect-square size-full object-cover group-data-[square=true]/avatar:rounded-none rounded-full",
        className
      )}
      {...props}
    />
...
function AvatarFallback({
  ...
  return (
    <AvatarPrimitive.Fallback
      ...
      className={cn(
        "flex size-full items-center justify-center rounded-full bg-muted text-sm text-muted-foreground group-data-[size=sm]/avatar:text-xs group-data-[square=true]/avatar:rounded-none",
        className
      )}
      {...props}
    />
